...
- Анализ потребности рынка в данном направлении
- Провести анализ существующих решений
- Постановка задачи на проектирование своего решения
- Выбор стека технологий

### Проектирование
- Проектирование диаграммы классов
- Проектирование диаграммы состояний
- Проектирование диаграммы взаимодействия
- Описание алгоритмов работы веб-приложения

### Разработка
- Разработка макетных форм веб-приложения
- Разработка UI-модулей веб-приложения
- Разработка Backend-части веб-приложения

### Тестирование
- Сценарий использования пользователем
- Финальное тестирование с малым количеством пользователей
